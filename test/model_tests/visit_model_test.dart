...
void main() {
  group("Visit model tests:", () {
    test("toMap() works.", () {
      var placement =
          Placement(count: 1, type: PlacementType.CampaignItem, notes: "placement notes");
    ...
    test("round trip", () {
      var placements = [Placement(count: 100, type: PlacementType.Book, notes: "placement note")];
