...
class ImageService {
  ...
  Future<Directory> get documentsDirectory => _applicationDocumentsDirectory.future;
  ...
  Future<String> saveToFile(Uint8List bytes, {String path, bool useRandomFileName = true, String filename, int height, int width}) async {
    I.Image image;
    bool isJpeg = false;
    try {
