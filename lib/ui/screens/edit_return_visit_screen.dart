...
class _EditReturnVisitScreenState extends State<EditReturnVisitScreen> with TickerProviderStateMixin {
                  ...
                  Positioned.fill(
                    ...
                    child: SingleChildScrollView(
                      child: Form(
                        ...
                        child: ReturnVisitPersonalInfoForm(returnVisitModel: widget.returnVisit,))
                    )),
                  Positioned(
                    bottom: 0.0,
                    child: FlatButton(
        ...
        children: <Widget>[
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(widget.returnVisit.lastVisitString, style: AppStyles.smallTextStyle.copyWith(fontWeight: FontWeight.bold),),
                  )
                ],),
            ),
          ),
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Address", style: AppStyles.smallTextStyle,),
                GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Selector<EditReturnVisitModel, String>(
                          ...
                          builder: (_, formattedAddress, __) => Text(formattedAddress, style: AppStyles.heading2,)),
                ...
                Container(height: 1, color: AppStyles.lightGrey,),
                Selector<EditReturnVisitModel, String>(
                ...
                Row(
                  children: <Widget>[
                    Text("Last Visit Date: ", style: AppStyles.smallTextStyle,),
                    Selector<EditReturnVisitModel, String>(
    ...
    for(var visit in visitsList) {
      ...
      children.add(TimelineCard(
        ...
        children: visit.visitType == VisitType.NotAtHome || (visit.placements.isEmpty && visit.nextTopic.isEmpty && visit.notes.isEmpty)
          ? null
          : <Widget>[
          if(visit.placements.isNotEmpty) Text(visit.placements, style: AppStyles.smallTextStyle.copyWith(fontWeight: FontWeight.bold),),
          if(visit.nextTopic.isNotEmpty) Text(visit.nextTopic, style: AppStyles.smallTextStyle),
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: 
            <Widget>[Padding(padding: EdgeInsets.only(top: AppStyles.topMargin),)] 
            + children ),
      ),
    );
  }
