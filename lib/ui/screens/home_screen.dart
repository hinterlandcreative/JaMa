...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<HomeModel>(
      ...
      body: Padding(
        padding: EdgeInsets.only(top: (AppStyles.timeHeaderBoxHeight / 2) + AppStyles.topMargin, left: AppStyles.leftMargin),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
              SliderButton(
                ...
                label: Text(
                  "Send " + DateFormat("MMMM").format(DateTime.now()) + " Report",
